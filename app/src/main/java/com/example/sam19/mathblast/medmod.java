...
public class medmod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medmod);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(medmod.this,dashmod.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(medmod.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
        galat++;
        String s;
