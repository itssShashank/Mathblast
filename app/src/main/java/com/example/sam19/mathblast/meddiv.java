...
public class meddiv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_meddiv);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(meddiv.this,dashdiv.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(meddiv.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
        galat++;
        String s;
