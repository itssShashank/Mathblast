...
public class hrdsub extends AppCompatActivity {
    Button b1,b2,b3,b4,b5,b6,b7,b8,b9,b0,bclear,btnminuss;
    TextView tv;
    EditText et,rite,wrng;
    int count=0,a,b,score=0,galat=0;
    double ans;
    String ttime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrdsub);
        b1=(Button)findViewById(R.id.button1);
        rite=(EditText)findViewById(R.id.right);
        wrng=(EditText)findViewById(R.id.wrong);
        btnminuss=(Button)findViewById(R.id.btnminus);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(hrdsub.this,dashsub.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(hrdsub.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
    ...
    public void rand(){
        ...
        a = rand.nextInt(500)+0;
        b= rand.nextInt(500)+1;
