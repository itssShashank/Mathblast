...
public class easydiv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easydiv);
...
checkk();
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(easydiv.this,dashdiv.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(easydiv.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
        galat++;
        String s;
