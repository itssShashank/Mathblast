...
public class easymull extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easymull);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(easymull.this,dashmul.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(easymull.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
        galat++;
        String s;
