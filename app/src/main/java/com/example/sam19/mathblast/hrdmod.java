...
public class hrdmod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrdmod);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(hrdmod.this,dashmod.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(hrdmod.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
        galat++;
        String s;
