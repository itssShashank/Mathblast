...
public class easymod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easymod);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(easymod.this,dashmod.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(easymod.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
        galat++;
        String s;
