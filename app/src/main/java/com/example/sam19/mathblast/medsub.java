...
public class medsub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medsub);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(medsub.this,dashsub.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(medsub.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
