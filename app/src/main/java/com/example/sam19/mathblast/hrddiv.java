...
public class hrddiv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrddiv);
    ...
    void question(){
        ...
        if(count<20){
            ...
            Intent intent = new Intent(hrddiv.this,dashdiv.class);
...
// Vibrate for 500 milliseconds
        ...
        Toast.makeText(hrddiv.this, "wrong answer", Toast.LENGTH_SHORT).show();
        question();
        et.setText("");
        galat++;
        String s;
